...
describe Puppet::Parser::AST::BooleanOperator do
    ...
    it "should return true for false OR true" do
        ast::BooleanOperator.new(:rval => @true_ast, :operator => "or", :lval => @false_ast).evaluate.should be_true
    end

    it "should return false for true AND false" do
        ast::BooleanOperator.new(:rval => @true_ast, :operator => "and", :lval => @false_ast ).evaluate.should be_false
    end

    it "should return true for true AND true" do
        ast::BooleanOperator.new(:rval => @true_ast, :operator => "and", :lval => @true_ast ).evaluate.should be_true
    end
