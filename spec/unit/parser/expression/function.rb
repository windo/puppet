...
describe Puppet::Parser::Expression::Function do
  ...
  describe "when initializing" do
    it "should not fail if the function doesn't exist" do
      ...
      lambda{ Puppet::Parser::Expression::Function.new :name => "dontexist" }.should_not raise_error(Puppet::ParseError)
  ...
  it "should return its representation with to_s" do
    ...
    Puppet::Parser::Expression::Function.new(:name => "func", :arguments => args).to_s.should == "func(a, b)"
  end
