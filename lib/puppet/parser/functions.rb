...
module Functions
    ...
    def self.newfunction(name, options = {}, &block)
        ...
        raise Puppet::DevError, "Function %s already defined" % name if @functions.include? name
    ...
    def self.rmfunction(name)
        ...
        raise Puppet::DevError, "Function %s is not defined" % name unless @functions.include? name
