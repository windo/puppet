...
class Puppet::Util::Log
    ...
    def Log.create(hash)
        ...
        raise Puppet::DevError, "Invalid log level %s" % hash[:level] unless @levels.index(hash[:level])
    ...
    def Log.level=(level)
        ...
        raise Puppet::DevError, "Invalid loglevel %s" % level unless @levels.include?(level)
