...
class Puppet::Indirector::Indirection
  ...
  def terminus(terminus_name = nil)
    ...
    raise Puppet::DevError, "No terminus specified for %s; cannot redirect" % self.name unless terminus_name ||= terminus_class
  ...
  def validate_terminus_class(terminus_class)
    raise ArgumentError, "Invalid terminus name %s" % terminus_class.inspect unless terminus_class and terminus_class.to_s != ""
  ...
  def check_authorization(request, terminus)
    ...
    unless terminus.authorized?(request)
      ...
      msg += " with %s" % request.options.inspect unless request.options.empty?
